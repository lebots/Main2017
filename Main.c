...
#pragma config(Motor,  port4,           R1Arm,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           R2Arm,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           FLDrive,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           BLDrive,       tmotorVex393_MC29, openLoop)
...
void updateMotors() {
	...
	motor[FLDrive] = LDriveVel;
	motor[BLDrive] = LDriveVel;
	motor[FRDrive] = RDriveVel;
	motor[BRDrive] = RDriveVel;
